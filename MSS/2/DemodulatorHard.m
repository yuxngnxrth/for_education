function y = DemodulatorHard(u, Mode)
    ...
    switch Mode
        case 1
            y = pskdemod(u, 4, pi/4, [0 2 3 1], 'OutputType', 'bit');
        case 2
            y = qamdemod(u, 16, map16, 'UnitAveragePower', true, 'OutputType', 'bit');
        case 3
            y = qamdemod(u, 64, map64, 'UnitAveragePower', true, 'OutputType', 'bit');
    end
end